...
<head>
	...
	<title>Henrique Domanski - Developer</title>

	<!-- Bootstrap core CSS -->
	<link href="css/bootstrap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="tablet/css/style.css">
	...
	<div id="boxWrapp">
			...
			<nav class="navbar navbar-inverse" role="navigation">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand bg-primary" href="#about">Henrique Domanski	</a>
					</div>
					...
					<div class="collapse navbar-collapse" id="NavCol">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="navbar-brand" href="#about" class="linear">Home</a></li>
							<li><a class="navbar-brand" href="#aboutMore" class="linear">Sobre</a></li>
							<li><a class="navbar-brand" href="#work" class="linear">Portifólio </a></li>
							<li><a class="navbar-brand" href="#contact" class="linear">Contato</a></li>
						</ul>
		...
		<div id="about" class="header">
			...
			<div class="main-caption">
				<div class="logo">
					<div style="margin-top: -300px" class="loader">
						<div class="dot"></div>
						<div class="dot"></div>
						<div class="dot"></div>
					</div>
				...
				<div id="flex-head" class="flexslider">
					<ul class="slides">
						<li>
							<h1>Henrique Domanski</h1>	
							<h2>Front-End Developer</h2>
						</li>
						<li>
							<h1>UI & UX</h1>	
							<h2>Criando uma experiência unica entre usuário e interface
								!!!
							</h2>
						</li>
						<li>
							<h1>Full Resposive Web</h1>	
							<h2>colocar definicao de  site responsivo</h2>	
						</li>
					</ul>
				</div> 
				<!-- end slider --> 
				<a href="#aboutMore" class="btn btnAbout btn-clear border-color color-primary btn-lg linear">Veja Mais</a>
				...
				<div class="row">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="main-avatar text-center">
										<div class="avatar img-thumbnail img-circle">
											<img src="img/moji.png" alt="avatar" />
										</div>
									</div>
								...
								<div class="col-md-9">
									<div class="about-content">
										<p>Olá, meu nome é Henrique Domanski! Sou desenvolvedor front-end e designer gráfico, atuo há mais de 4 anos com desenvolvimento de Websites e implementação de aplicações em empresas, e gostaria de ajudar você a levar o seu produto para o próximo nível.</p>
									</div>
									<a class="btn btn-primary"  href="https://goo.gl/TRNtEK" target="_blank" ><i class="fa fa-download"></i> Download CV</a>
					...
					<div class="col-md-6">
						<div class="build progressbar-a">
							...
							<div class="wrapp-progress">
								<p class="pull-left">JavaScript</p> 
								<div class="progress">
										...
										<div class="portfolio-item ">
											<div class="thumbnail">
												<div class="thumb-img">
													...
													<div class="link-attr">
														<a href="img/portfolio/wallpaper3.jpg" data-gallery="global-gallery" data-parent="" data-toggle="lightbox" data-title="Rock S/A" class="link-search animated linear"><i class="fa fa-search"></i></a>
														<a href="preview/rocksa/index.html" target="_blank" class="link-chain animated linear"><i class="fa  fa-chain"></i></a>
													</div>
													<img class="linear img-portfolio img-responsive" src="img/portfolio/wallpaper3.jpg" alt="This Is Image">


													<div class="folio-caption">
														<i class="fa fa-caret-up"></i>
														<p>Preview: Web Radio - Rock S/A</p>
									...
									<div class="folio-img">
										<div class="portfolio-item">
											<div class="thumbnail">
												<div class="thumb-img">
													<div class="link-attr">
														<a href="img/portfolio/p02-large.jpg" data-gallery="global-gallery" data-parent="" data-toggle="lightbox" data-title="Juliana Balduino - MAKE UP" class="link-search animated linear"><i class="fa fa-search"></i></a>
														<a href="preview/julianabalduino/index.html" target="_blank" class="link-chain animated linear"><i class="fa  fa-chain"></i></a>
													</div>
													<img class="linear img-portfolio img-responsive" src="img/portfolio/p02-large.jpg" alt="This Is Image">

													<div class="folio-caption">
														<i class="fa fa-caret-up"></i>
														<p>Preview: Juliana Balduino</p>
													</div>
												</div>
											</div>
										</div>
		...
		<!--contact-->
		<div id="contact" class="page clearfix">
			<div class="container">
				<div class="row">
					<div class="col-md-10  col-md-offset-1">
						<div class="build title-page">
				...
				<div class="row">
					<div class="col-md-4 ">
						<div class="build contact clearfix text-center">
							...
							<p><b>São Paulo - SP</b> <br /><b>Brazil</b><p>
							</div>			
						</div><!-- end col -->
						<div class="col-md-4 ">
							<div class="build contact clearfix text-center">
								<span class="fa fa-phone"></span>
								<p><b>tel.</b><a href="tel:+824 2344 5602"><b>+55 11 949399221</b></a></p>
						...
						<div class="col-md-4 ">
							<div class="build contact clearfix text-center">
								<a style="color: #7a7a7a;" class="launch-modal" href="#" data-modal-id="modal-register">
			...
			<footer class="bg-black">
				<div class="container">
					<div class="row">
						<div class="col-md-6 ">
							<div class="cp-right">
								<p> &copy; 2018 <a class="color-primary linear">Henrique Domanski</a>. All Rights Reserved. </p>
							</div><!-- end build -->
						</div><!-- end col -->
						...
						<div class="col-md-6 text-right">
							...
							<ul class="list-inline">
								<li><a href="https://github.com/henriquedomanski" target="_blank" class="socIcon color-primary linear"><i class="fa fa-github fa-2x"></i></a></li>
								<li><a href="https://twitter.com/HenriqeDomanski" target="_blank" class="socIcon color-primary linear"><i class="fa fa-twitter fa-2x"></i></a></li>
							</ul>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-header">
							...
							<h3 class="modal-title" id="modal-register-label">Entre Em Contato</h3>

						</div>

						<div class="modal-body">
							<!-- INICIO DO FORMULARIO -->
							<form role="form" action="enviar_email.php" method="post" class="registration-form">
								<div class="form-group">
									<label class="sr-only" for="form-first-name">Seu Nome</label>
									<input type="text" name="nome" placeholder="Digite seu nome..." class="form-first-name form-control" id="form-first-name">
								</div>
								...
								<div class="form-group">
									<label class="sr-only" for="form-about-yourself">Mensagem</label>
									<textarea name="mensagem" placeholder="Digite a sua mensagem..." 
